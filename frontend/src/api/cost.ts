...
export const costApi = {
  getAnalytics: (params?: { application_id?: string; date_from?: string; date_to?: string; group_by?: string; timeRange?: string }) =>
  ...
  createBudgetAlert: (data: { application_id?: string; budget_usd?: number; period?: string; alert_pct?: number[]; name?: string; threshold?: number }) =>
