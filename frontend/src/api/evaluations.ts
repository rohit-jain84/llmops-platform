...
export const evaluationsApi = {
  ...
  listCampaigns: (applicationId?: string) =>
    apiClient.get<HumanEvalCampaign[]>('/eval/campaigns', { params: applicationId ? { application_id: applicationId } : {} }).then(r => r.data),
  ...
  submitRating: (assignmentId: string, data: { ratings: Record<string, number | string>; notes?: string; comment?: string }) =>
